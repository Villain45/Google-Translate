### This project is an exact clone of Google translate it uses react as its frontend and the languages with the translated text are fetched from backend using API Calls
